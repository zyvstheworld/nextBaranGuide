...
export default function AboutPage() {
  ...
  return (
    <div className="promo-page">
      ...
      <section className="hero-banner">
        <div className="hero-inner">
          <div className="hero-content">
            <h2>About Old Cabalan</h2>
            <p>
              A historic coastal barangay in Olongapo with rich heritage, vibrant
              community spirit, and beautiful seaside views. We are committed to
              preserving our traditions while delivering excellent service to our
              residents.
            </p>
          </div>
        ...
        <div className="hero-highlights">
          <article className="highlight">
            ...
            <div className="highlight-body">
              <h4>Our Heritage</h4>
              <p>Rich history and cultural traditions of Old Cabalan.</p>
            </div>
          </article>
          ...
          <article className="highlight">
            ...
            <div className="highlight-body">
              <h4>Our Community</h4>
              <p>Strong bonds and neighborhood spirit among residents.</p>
            </div>
          </article>
          ...
          <article className="highlight">
            ...
            <div className="highlight-body">
              ...
              <p>Coastal charm and scenic views of Old Cabalan.</p>
            </div>
          </article>
        </div>
      </section>
        ...
        <section className="about-section">
          <div className="about-grid">
            <div className="vision-mission-wrapper">
              <h1 className="section-title">BARANGAY OLD CABALAN</h1>
                ...
                <div className="text-container">
                  ...
                  <div className="text-section">
                    ...
                    <p className="text-content">
                      Residents of Barangay Old Cabalan shall be given equal rights and opportunities to access comprehensive healthcare and nutrition, live in a peaceful and safe environment, and become literate, intellectually capable, God-centered, and law-abiding citizens. Guided by integrity, transparency, and active citizen participation, Barangay Old Cabalan can realize its full potential and be elevated to greater heights - in pursuit of a GREATER OLD CABALAN.
                    </p>
                  </div>
                  ...
                  <div className="text-section">
                    ...
                    <p className="text-content">
                      To uphold the mandate of the Local Government Code by delivering efficient and inclusive public services, maintaining peace and order, enforcing laws and ordinances, promoting health, education, and welfare, and ensuring that every client and constituent is treated with fairness, respect, and dedication - even beyond official working hours, in compliance with R.A. 11032.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="about-card">
              ...
              <ul className="facts-list">
                <li>
                  <strong>Population:</strong> Approx. 12,000
                </li>
                <li>
                  <strong>Established:</strong> 1900s
                </li>
                <li>
                  <strong>Location:</strong> Olongapo City
                </li>
                <li>
                  <strong>Character:</strong> Coastal & Historic
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* Chat plugin (modal) */}
      <div
        className={`chat-plugin ${isOpen ? "open" : ""}`}
        role="dialog"
        aria-hidden={!isOpen}
      >
        ...
        <div className="plugin-body">
          ...
          <form className="input-area" onSubmit={handleSubmit}>
            <input
              ...
              placeholder="Ask about our barangay..."
              disabled={loading}
              aria-label="Message"
            />
            <button
      ...
      <style jsx>{`
        ...
        .main-nav .nav-link:hover {
          background: rgba(11, 78, 214, 0.06);
          color: #0b4ed6;
        }
        ...
        .hero-inner {
          ...
          padding: 20px;
          border-radius: 12px;
          box-shadow: 0 8px 24px rgba(4, 12, 44, 0.06);
        }
        .hero-content {
          flex: 1;
        }
        ...
        .highlight {
          ...
          border-radius: 8px;
          overflow: hidden;
          box-shadow: 0 6px 18px rgba(2, 8, 35, 0.04);
        }
        .highlight-body {
          padding: 12px;
        }
        ...
        .floating-launch {
          ...
          align-items: center;
          justify-content: center;
          box-shadow: 0 10px 30px rgba(11, 78,
