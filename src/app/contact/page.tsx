    ...
    <div className="promo-page">
      <header className="site-header">
        <div className="brand-left">
          <Image src="/olongapo-seal.png" alt="BaranGuide" width={140} height={44} />
        ...
        <nav className={`main-nav ${navOpen ? "open" : ""}`} aria-label="Main navigation">
          <ul>
            ...
            <li><a className="nav-link" href="/contact" aria-current="page">Contact</a></li>
          </ul>
        </nav>
      ...
      <section className="hero-banner">
        <div className="hero-inner">
          <div className="hero-content">
            <h2>Get In Touch</h2>
            <p>
              Have questions or need assistance? Contact Barangay Old Cabalan Hall for
              inquiries about services, programs, and community matters. We're here to help!
            </p>
          </div>

          <div className="hero-image">
            <Image src="/contact.jpg" alt="Contact us" width={720} height={420} style={{ objectFit: 'cover', borderRadius: 12 }} />
          </div>
        </div>

        <div className="hero-highlights">
          <article className="highlight">
            <Image src="/phone.jpg" alt="Phone" width={420} height={220} style={{ objectFit: 'cover', borderRadius: 8 }} />
          ...
          <article className="highlight">
            <Image src="/email.jpg" alt="Email" width={420} height={220} style={{ objectFit: 'cover', borderRadius: 8 }} />
            <div className="highlight-body">
              <h4>Email</h4>
              <p>brgy.oldcabalan.1988@gmail.com</p>
            </div>
          </article>

          <article className="highlight">
            <Image src="/office.jpg" alt="Office" width={420} height={220} style={{ objectFit: 'cover', borderRadius: 8 }} />
            <div className="highlight-body">
              <h4>Visit Us</h4>
              <p>Narra Lane, Purok 11, Old Cabalan, Olongapo City</p>
            </div>
          </article>
        </div>
      </section>
        ...
        <section className="contact-section">
          <div className="contact-grid">
            <div className="contact-info">
              <h3>Barangay Hall Hours</h3>
              <p><strong>Monday - Friday:</strong> 8:00 AM - 5:00 PM</p>
              <p><strong>Saturday:</strong> 8:00 AM - 12:00 PM</p>
              <p><strong>Sunday & Holidays:</strong> Closed</p>

              <h3 style={{ marginTop: '18px' }}>Quick Links</h3>
              <ul style={{ listStyle: 'none', padding: 0 }}>
                <li><a href="#" style={{ color: '#0b4ed6', textDecoration: 'none' }}>Barangay Hotline</a></li>
                <li><a href="#" style={{ color: '#0b4ed6', textDecoration: 'none' }}>Request a Service</a></li>
                <li><a href="#" style={{ color: '#0b4ed6', textDecoration: 'none' }}>Report an Issue</a></li>
              </ul>
            </div>

            <div className="contact-map">
              <iframe
                title="Old Cabalan Map"
                src="https://www.google.com/maps?q=olongapo&output=embed"
                width="100%"
                height="360"
        ...
        <div className="plugin-body">
          ...
          <form className="input-area" onSubmit={handleSubmit}>
            <input
              ...
              placeholder="Ask for assistance or more information..."
              disabled={loading}
              aria-label="Message"
            />
      ...
      <style jsx>{`
        ...
        .contact-section { background:white; padding:20px; border-radius:12px; box-shadow:0 8px 24px rgba(4,12,44,0.06); }
        .contact-section h3 { margin:0 0 12px; color:#0b4ed6; }
        .contact-grid { display:grid; grid-template-columns:1fr 1fr; gap:20px; }
        .contact-info p { margin:4px 0; color:#475569; }
