...
export default function AnnouncementsPage() {
  ...
  const announcements = [
    { title: "Clean-Up Drive", date: "Oct 5, 2025", excerpt: "Volunteer community clean-up at the coastal park." },
    { title: "Health Caravan", date: "Sep 18, 2025", excerpt: "Free screening and vaccination at the barangay hall." },
    { title: "Town Meeting", date: "Aug 30, 2025", excerpt: "Public forum on community development and safety." },
  ];
  ...
  return (
    <div className="promo-page">
      <header className="site-header">
        ...
        <nav className={`main-nav ${navOpen ? "open" : ""}`} aria-label="Main navigation">
          <ul>
            ...
            <li><a className="nav-link" href="/announcements" aria-current="page">Announcements</a></li>
      ...
      <section className="hero-banner">
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <p>
              Stay informed with the latest news, updates, and events from Barangay Old Cabalan.
              Get details on community programs, health initiatives, and local schedules.
            </p>
          </div>

          <div className="hero-image">
            <Image src="/announcement.jpg" alt="Announcements banner" width={720} height={420} style={{ objectFit: 'cover', borderRadius: 12 }} />
          </div>
        </div>

        <div className="hero-highlights">
          <article className="highlight">
            <Image src="/event.jpg" alt="Events" width={420} height={220} style={{ objectFit: 'cover', borderRadius: 8 }} />
            <div className="highlight-body">
              <h4>Community Events</h4>
              <p>Upcoming events and community activities.</p>
            </div>
          </article>

          <article className="highlight">
            <Image src="/health-announce.jpg" alt="Health News" width={420} height={220} style={{ objectFit: 'cover', borderRadius: 8 }} />
            <div className="highlight-body">
              <h4>Health Updates</h4>
              <p>Latest health programs and vaccination schedules.</p>
            </div>
          </article>

          <article className="highlight">
            <Image src="/schedule.jpg" alt="Schedules" width={420} height={220} style={{ objectFit: 'cover', borderRadius: 8 }} />
            <div className="highlight-body">
              <h4>Important Dates</h4>
              <p>Key schedules and deadlines to remember.</p>
            </div>
          </article>
        </div>
      </section>
        ...
        <section className="announcements-list">
          ...
          <div className="announcement-cards">
            {announcements.map((announce, idx) => (
              <article key={idx} className="announcement-card">
                <div className="announce-header">
                  <h4>{announce.title}</h4>
                  <small>{announce.date}</small>
                </div>
        ...
        <div className="plugin-body">
          ...
          <form className="input-area" onSubmit={handleSubmit}>
            <input
              ...
              placeholder="Ask about announcements or events..."
              disabled={loading}
              aria-label="Message"
            />
      ...
      <style jsx>{`
        ...
        .announcements-list h3 { margin:0 0 12px; color:#0b4ed6; }
        .announcement-cards { display:grid; grid-template-columns:repeat(1,1fr); gap:12px; }
        .announcement-card { background:white; border-radius:10px; padding:16px; box-shadow:0 6px 18px rgba(2,8,35,0.04); border-left:4px solid #0b4ed6; }
        .announce-header { display:flex; justify-content:space-between; align-items:start; margin-bottom:8px; }
        .announce-header h4 { margin:0; color:#06123b; }
        .announce-header small { color:#64748b; font-size:0.9rem; }
        .announcement-card p { margin:8px 0; color:#475569; }
        .read-more { color:#0b4ed6; text-decoration:none; font-weight:600; }
        ...
        @media (max-width: 900px) {
          .announcement-cards { grid-template-columns:repeat(1,1fr); }
